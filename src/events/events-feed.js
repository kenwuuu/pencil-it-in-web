  ...
  connectedCallback() {
    this.innerHTML = `
      ...
      <!--                        end participants component -->
                              <button class="download-calendar-btn btn btn-ghost p-1 block sm:hidden" x-on:click.stop="downloadCalendar(event)">
                            ...
                            <button class="download-calendar-btn btn btn-ghost p-1 hidden sm:block" x-on:click.stop="downloadCalendar(event)">
                              <iconify-icon class="text-3xl sm:text-2xl" icon="mdi:calendar-export"></iconify-icon>
                            </button>
                          </div>
                        </div>
